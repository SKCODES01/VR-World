        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 place-items-center">
          ...
          <div className=" lg:pr-20 relative">
            <div className="relative z-10 space-y-5">
              ...
              Virtual reality (VR) is a three-dimensional, simulated environment that is generated by computer technology. VR focuses on an experiential interface rather than observational.
              </p>
