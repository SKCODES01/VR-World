        ...
        <div className="container min-h-[700px] flex relative">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 place-items-center relative z-10">
            ...
            <div className="order-2 sm:order-1 space-y-5 lg:pr-20 relative z-30">
              ...
              VR games is a video game played on virtual reality (VR) hardware. The advent of VR in gaming marks a significant milestone in the quest for fully immersive digital experiences. 
              </p>
