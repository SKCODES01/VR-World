...
const FeaturesData = [
  {
    ...
    link: "#",
    description: "Immersive video content that creates the illusion of the viewer actually being in the video itself.",
    aosDelay: "300",
  },
  {
    ...
    link: "#",
    description: "Consumers have grown increasingly accustomed to the world of Augmented Reality (AR) and Virtual Reality (VR).",
    aosDelay: "500",
  },
  {
    ...
    link: "#",
    description: "Designed to make you feel immersed in a virtual world. ",
    aosDelay: "700",
  },
];
